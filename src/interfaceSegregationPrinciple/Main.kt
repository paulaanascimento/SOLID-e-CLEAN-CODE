...
fun main() {
    ...
    val textDocument:TextDocument = TextDocumentTxt("src/interfaceSegregationPrinciple/resources/solid.txt")
    textDocument.open()
    ...
    val imageDocument:ImageDocument = ImageDocumenImpl(imageFile)
